...
- Bước 2: Click vào dòng `Re-schedule the next check of this service`. Tham khảo: <img src = "http://prntscr.com/es7ar0">
- Bước 3: Click vào nút commit. Tham khảo: <img src = "http://prntscr.com/es7b2u">
